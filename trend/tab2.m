...
% fomc dates
%tight = table2timetable(readtable('C:/Users/lexmg15/Google_Drive/Nottingham/ReplicationGames/Paper_candidates/Bauer_Lakdawala_Mueller_MarketBasedMP/replication_package/data/fomc_dates.csv'));
tight = table2timetable(readtable('/Users/cgriffa/My Drive/Nottingham/ReplicationGames/Paper_candidates/Bauer_Lakdawala_Mueller_MarketBasedMP/replication_package/data/fomc_dates.csv'));

% mpu
%mpu_tt = table2timetable(readtable('C:/Users/lexmg15/Google_Drive/Nottingham/ReplicationGames/Paper_candidates/Bauer_Lakdawala_Mueller_MarketBasedMP/replication_package/data/mpu.csv'));
mpu_tt = table2timetable(readtable('/Users/cgriffa/My Drive/Nottingham/ReplicationGames/Paper_candidates/Bauer_Lakdawala_Mueller_MarketBasedMP/replication_package/data/mpu.csv'));
mpu10 = mpu_tt.mpu10; 
...
% load sep dates
%(CG: I skipped the line below, doesnt work) 
